package fiap.com.br.ecommerce.aplicacao;
...
// Metodo para cadastrar os produtos
	public void cadastrarProdutos(String codigo, String descricao, double preco, String data) {
		...
		JOptionPane.showMessageDialog(null, "Produto cadastrado com sucesso.", "Bomboniere XYZ",
...
// String dados = "";
		for (Itens produtos : Produtos) {
			dados += " Código do produto: " + produtos.codigo + " Descrição do produto: " + produtos.descricao
					+ " Preço do produto: R$: " + produtos.preco + " Data do cadastro: " + produtos.data + "\n";
		}
		return dados;
...
// texto.write(mostrarProdutos().replaceAll("\n", "\r\n"));
			for (Itens produtos : Produtos) {
				texto.write(("Código do produto: " + produtos.codigo + " Descrição do produto: " + produtos.descricao
						+ " Preço do produto: R$: " + produtos.preco + " Data do cadastro: " + produtos.data + "\n")
								.replaceAll("\n", "\r\n"));
			}
// passa para a proxima linha
...
// Fecha o arquivo e libera-o
			texto.close();
			JOptionPane.showMessageDialog(null, "Produto salvo com sucesso.", "Bomboniere XYZ",
					JOptionPane.INFORMATION_MESSAGE);
		} // fim try
		catch (Exception ex) {
			Toolkit.getDefaultToolkit().beep();
			JOptionPane.showMessageDialog(null, "Erro ao salvar o documento!", "Cadastro De Produtos: Bomboniere XYZ",
...
// File("C:/users/aluno/Desktop/Bomboniere.txt");
			File arquivo = new File(System.getProperty("user.dir") + "Bomboniere XYZ.txt");
...
// escreve a data do sistema
				...
				imprimir.println(" ");
				for (Itens produtos : Produtos) {
					imprimir.println("Código do produto: " + produtos.codigo + " Descrição do produto: "
							+ produtos.descricao + " Preço do produto: R$: " + produtos.preco + " Data do cadastro: "
							+ produtos.data);
				}
...
// tratamento de erros aqui
				Toolkit.getDefaultToolkit().beep();
				JOptionPane.showMessageDialog(null, "Erro ao imprimir o documento!",
						"Cadastro De Produtos: Bomboniere XYZ", JOptionPane.ERROR_MESSAGE);
			} finally {
				if (imprimir != null) {
// Fecha o arquivo txt
					imprimir.close();
// Deleta o arquivo criado depois de fechar a aplicação
			...
			Toolkit.getDefaultToolkit().beep();
			JOptionPane.showMessageDialog(null, "Não há produtos cadastrados!", "Cadastro De Produtos: Bomboniere XYZ",
					JOptionPane.ERROR_MESSAGE);
		}
	}
